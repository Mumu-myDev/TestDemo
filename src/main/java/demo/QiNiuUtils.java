...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "SgA4cJbdu00h3RgWTHjc_2PJmnlvcPf-pKp4jQVG";
    private static final String SECRETKEY = "cOglEKeym-6Uc3IwF0fGl5nzLBBgdHOHgdUH_R2K";
    private static final String BUCKET = "as1366414844";
    public static final String DOMAIN= "http://r07dhvkf1.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
       uploadFile("d:\\mz.jpg","mza.jpg");
